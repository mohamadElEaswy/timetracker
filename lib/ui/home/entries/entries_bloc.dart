...
import 'package:timetracker/ui/home/entries/daily_jobs_details.dart';
import 'package:timetracker/ui/home/entries/entries_list_tile.dart';
import 'package:timetracker/ui/home/entries/entry_job.dart';
  ...
  static List<EntryJob> _entriesJobsCombiner(
    ...
    return entries.map((entry) {
      final job = jobs.firstWhere(
        ...
        orElse: () {
          return Job(name: '', ratePerHour: 0, id: entry.jobId!);
        },
      );
